...
`ifdef FTILE_PTP_HSSI_100G_GAUI2_PAM4
`define NUM_INST 4
`else
`define NUM_INST 2
`endif
...
localparam HSSI0_SS_BASE_ADDR                   = 64'h000_0000;
localparam HSSI1_SS_BASE_ADDR                   = 64'h400_0000;
localparam QSFP_BASE_ADDR                       = 64'h84d_0000;
localparam PTP_BRIDGE_BASE_ADDR                 = 64'h805_0000;
localparam PTP_TCAM0_BASE_ADDR                  = 64'h805_0200;
localparam PTP_TCAM0_KEY_BASE_ADDR              = 64'h805_1200;
localparam PTP_TCAM0_RESULT_BASE_ADDR           = 64'h805_2200;
localparam PTP_TCAM0_MASK_BASE_ADDR             = 64'h805_3200;

localparam PTP_TCAM1_BASE_ADDR                  = 64'h805_4200;
localparam PTP_TCAM1_KEY_BASE_ADDR              = 64'h805_5200;
localparam PTP_TCAM1_RESULT_BASE_ADDR           = 64'h805_6200;
localparam PTP_TCAM1_MASK_BASE_ADDR             = 64'h805_7200;

localparam PKTCLI0_BASE_ADDR                    = 64'h806_0000;
localparam PKTCLI1_BASE_ADDR                    = 64'h807_0000;
localparam OCM_BASE_ADDR                        = 64'h400_0000;
localparam MAIN_TOD_SS_BASE_ADDR                = 64'h404_0000;

localparam DMA_PORT0_BASE_TXDMA_PREF_ADDR       = 64'h848_0000;
localparam DMA_PORT0_BASE_TXDMA_CSR_ADDR        = 64'h848_0020;
localparam DMA_PORT0_BASE_RXDMA_PREF_ADDR       = 64'h848_0080;
localparam DMA_PORT0_BASE_RXDMA_CSR_ADDR        = 64'h848_00A0;

localparam DMA_PORT1_BASE_TXDMA_PREF_ADDR       = 64'h84C_0000;
localparam DMA_PORT1_BASE_TXDMA_CSR_ADDR        = 64'h84C_0020;
localparam DMA_PORT1_BASE_RXDMA_PREF_ADDR       = 64'h84C_0080;
localparam DMA_PORT1_BASE_RXDMA_CSR_ADDR        = 64'h84C_00A0;


localparam DMA_PORT2_BASE_TXDMA_PREF_ADDR       = 64'h850_0000;
localparam DMA_PORT2_BASE_TXDMA_CSR_ADDR        = 64'h850_0020;
localparam DMA_PORT2_BASE_RXDMA_PREF_ADDR       = 64'h850_0080;
localparam DMA_PORT2_BASE_RXDMA_CSR_ADDR        = 64'h850_00A0;


localparam DMA_PORT3_BASE_TXDMA_PREF_ADDR       = 64'h854_0000;
localparam DMA_PORT3_BASE_TXDMA_CSR_ADDR        = 64'h854_0020;
localparam DMA_PORT3_BASE_RXDMA_PREF_ADDR       = 64'h854_0080;
localparam DMA_PORT3_BASE_RXDMA_CSR_ADDR        = 64'h854_00A0;

localparam DMA_PORT4_BASE_TXDMA_PREF_ADDR       = 64'h858_0000;
localparam DMA_PORT4_BASE_TXDMA_CSR_ADDR        = 64'h858_0020;
localparam DMA_PORT4_BASE_RXDMA_PREF_ADDR       = 64'h858_0080;
localparam DMA_PORT4_BASE_RXDMA_CSR_ADDR        = 64'h858_00A0;

localparam DMA_PORT5_BASE_TXDMA_PREF_ADDR       = 64'h85C_0000;
localparam DMA_PORT5_BASE_TXDMA_CSR_ADDR        = 64'h85C_0020;
localparam DMA_PORT5_BASE_RXDMA_PREF_ADDR       = 64'h85C_0080;
localparam DMA_PORT5_BASE_RXDMA_CSR_ADDR        = 64'h85C_00A0;

localparam DMA_PORT0_BASE_ADDR       = 64'h848_0000;
localparam DMA_PORT1_BASE_ADDR       = 64'h84C_0000;
localparam DMA_PORT2_BASE_ADDR       = 64'h850_0000;
localparam DMA_PORT3_BASE_ADDR       = 64'h854_0000;
localparam DMA_PORT4_BASE_ADDR       = 64'h858_0000;
localparam DMA_PORT5_BASE_ADDR       = 64'h85C_0000;
...
localparam PORT5_RXDESC_BASE_ADDR      = 64'h1280_0000;
  ...
  localparam HSSI0_DEV_FEAT_HDR_LO            = HSSI0_SS_BASE_ADDR+64'h0;   
  localparam HSSI0_DEV_FEAT_HDR_HI            = HSSI0_SS_BASE_ADDR+64'h4;   
  localparam HSSI0_FEAT_GUID_L_LSB            = HSSI0_SS_BASE_ADDR+64'h8;   
  localparam HSSI0_FEAT_GUID_L_MSB            = HSSI0_SS_BASE_ADDR+64'hC;   
  localparam HSSI0_FEAT_GUID_H_LSB            = HSSI0_SS_BASE_ADDR+64'h10;   
  localparam HSSI0_FEAT_GUID_H_MSB            = HSSI0_SS_BASE_ADDR+64'h14;   
  localparam HSSI0_FEAT_CSR_ADDR_LSB          = HSSI0_SS_BASE_ADDR+64'h18;   
  localparam HSSI0_FEAT_CSR_ADDR_MSB          = HSSI0_SS_BASE_ADDR+64'h1C;   
  localparam HSSI0_FEAT_CSR_ADDR_SG_LSB       = HSSI0_SS_BASE_ADDR+64'h20;   
  localparam HSSI0_FEAT_CSR_ADDR_SG_MSB       = HSSI0_SS_BASE_ADDR+64'h24;   
  localparam HSSI0_ANLT_BASE_ADDR             = HSSI0_SS_BASE_ADDR+'h12000;   


  localparam HSSI1_DEV_FEAT_HDR_LO            = HSSI1_SS_BASE_ADDR+64'h0;   
  localparam HSSI1_DEV_FEAT_HDR_HI            = HSSI1_SS_BASE_ADDR+64'h4;   
  localparam HSSI1_FEAT_GUID_L_LSB            = HSSI1_SS_BASE_ADDR+64'h8;   
  localparam HSSI1_FEAT_GUID_L_MSB            = HSSI1_SS_BASE_ADDR+64'hC;   
  localparam HSSI1_FEAT_GUID_H_LSB            = HSSI1_SS_BASE_ADDR+64'h10;   
  localparam HSSI1_FEAT_GUID_H_MSB            = HSSI1_SS_BASE_ADDR+64'h14;   
  localparam HSSI1_FEAT_CSR_ADDR_LSB          = HSSI1_SS_BASE_ADDR+64'h18;   
  localparam HSSI1_FEAT_CSR_ADDR_MSB          = HSSI1_SS_BASE_ADDR+64'h1C;   
  localparam HSSI1_FEAT_CSR_ADDR_SG_LSB       = HSSI1_SS_BASE_ADDR+64'h20;   
  localparam HSSI1_FEAT_CSR_ADDR_SG_MSB       = HSSI1_SS_BASE_ADDR+64'h24;   
  localparam HSSI1_ANLT_BASE_ADDR             = HSSI1_SS_BASE_ADDR+'h12400;   
