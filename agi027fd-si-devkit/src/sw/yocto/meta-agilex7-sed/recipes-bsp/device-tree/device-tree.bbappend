do_configure:append() {
		...
		cp ${STAGING_KERNEL_DIR}/arch/${ARCH}/boot/dts/intel/socfpga_fm87_ftile_2port_2conn_mcq_ptp_dr.dts ${WORKDIR}/socfpga_fm87_ftile_2port_2conn_mcq_ptp_dr.dts
		cp ${STAGING_KERNEL_DIR}/arch/${ARCH}/boot/dts/intel/fm87_ftile_2port_2conn_mcq_ptp_dr.dtsi ${WORKDIR}/fm87_ftile_2port_2conn_mcq_ptp_dr.dtsi
