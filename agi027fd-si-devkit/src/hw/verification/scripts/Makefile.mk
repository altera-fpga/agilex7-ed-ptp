...
ifdef HSSI_100G
	VLOG_OPT += +define+RTLSIM +define+__ALTERA_STD__METASTABLE_SIM +define+UNHIDE_cr3v0 -hsopt=gates +systemverilogext+.sv +define+TIMESCALE_EN +define+IP7581SERDES_UXS2T1R1PGD_PIPE_SPEC_FORCE +define+IP7581SERDES_UXS2T1R1PGD_PIPE_SIMULATION +define+IP7581SERDES_UXS2T1R1PGD_PIPE_FAST_SIM +define+INTC_FUNCTIONAL +define+SPEC_FORCE +define+__ALTERA_STD__METASTABLE_SIM +define+RDY_LAT=0 +define+EHIP +define+FAST_CLK +define+CRETE3 +define+ACDS_19_1 +define+SIM_MODE +define+FTILE_PTP_HSSI_100G_GAUI2_PAM4 +define+MAC_SRD_CFG_25G +define+HSSI_2P100G +define+SRC_SPEC_SPEED_UP +define+SSM_SEQUENCE +define+IP7581SERDES_UX_SIMSPEED +define+UX_WORD_CLK_DRIFT_CORRECTION +define+IP7581SERDES_UXS2T1R1PGD_PIPE_SKIP_LOAD_SPEC +define+__SRC_TEST__ 
else ifdef HSSI_50G
	VLOG_OPT += +define+RTLSIM +define+__ALTERA_STD__METASTABLE_SIM +define+UNHIDE_cr3v0 -hsopt=gates +systemverilogext+.sv +define+TIMESCALE_EN +define+IP7581SERDES_UXS2T1R1PGD_PIPE_SPEC_FORCE +define+IP7581SERDES_UXS2T1R1PGD_PIPE_SIMULATION +define+IP7581SERDES_UXS2T1R1PGD_PIPE_FAST_SIM +define+INTC_FUNCTIONAL +define+SPEC_FORCE +define+__ALTERA_STD__METASTABLE_SIM +define+RDY_LAT=0 +define+EHIP +define+FAST_CLK +define+CRETE3 +define+ACDS_19_1 +define+SIM_MODE +define+FTILE_PTP_HSSI_50G_AUI1_PAM4 +define+MAC_SRD_CFG_25G +define+HSSI_2P50G +define+SRC_SPEC_SPEED_UP +define+SSM_SEQUENCE +define+IP7581SERDES_UX_SIMSPEED +define+UX_WORD_CLK_DRIFT_CORRECTION +define+IP7581SERDES_UXS2T1R1PGD_PIPE_SKIP_LOAD_SPEC +define+__SRC_TEST__ 
else ifdef HSSI_25G
	VLOG_OPT += +define+RTLSIM +define+__ALTERA_STD__METASTABLE_SIM +define+UNHIDE_cr3v0 -hsopt=gates +systemverilogext+.sv +define+TIMESCALE_EN +define+IP7581SERDES_UXS2T1R1PGD_PIPE_SPEC_FORCE +define+IP7581SERDES_UXS2T1R1PGD_PIPE_SIMULATION +define+IP7581SERDES_UXS2T1R1PGD_PIPE_FAST_SIM +define+INTC_FUNCTIONAL +define+SPEC_FORCE +define+__ALTERA_STD__METASTABLE_SIM +define+RDY_LAT=0 +define+EHIP +define+FAST_CLK +define+CRETE3 +define+ACDS_19_1 +define+SIM_MODE +define+FTILE_PTP_HSSI_10G_25G +define+FTILE_PTP_HSSI_25G +define+MAC_SRD_CFG_25G +define+HSSI_2P25G +define+SRC_SPEC_SPEED_UP +define+SSM_SEQUENCE +define+IP7581SERDES_UX_SIMSPEED +define+UX_WORD_CLK_DRIFT_CORRECTION +define+IP7581SERDES_UXS2T1R1PGD_PIPE_SKIP_LOAD_SPEC +define+__SRC_TEST__ 
else ifdef HSSI_10G
	VLOG_OPT += +define+RTLSIM +define+__ALTERA_STD__METASTABLE_SIM +define+UNHIDE_cr3v0 -hsopt=gates +systemverilogext+.sv +define+TIMESCALE_EN +define+IP7581SERDES_UXS2T1R1PGD_PIPE_SPEC_FORCE +define+IP7581SERDES_UXS2T1R1PGD_PIPE_SIMULATION +define+IP7581SERDES_UXS2T1R1PGD_PIPE_FAST_SIM +define+INTC_FUNCTIONAL +define+SPEC_FORCE +define+RDY_LAT=0 +define+EHIP +define+FAST_CLK +define+CRETE3 +define+ACDS_19_1 +define+SIM_MODE +define+FTILE_PTP_HSSI_10G_25G +define+FTILE_PTP_HSSI_10G +define+MAC_SRD_CFG_25G +define+HSSI_2P10G +define+SRC_SPEC_SPEED_UP +define+SSM_SEQUENCE +define+IP7581SERDES_UX_SIMSPEED +define+UX_WORD_CLK_DRIFT_CORRECTION +define+IP7581SERDES_UXS2T1R1PGD_PIPE_SKIP_LOAD_SPEC +define+__SRC_TEST__ 
endif
...
gen_ip_lib:
	...
	cp -f synopsys/vcsmx/synopsys_sim.setup ../ip_libraries/
	cd ../ip_libraries && sh ../scripts/synopsys/vcsmx/vcsmx_setup.sh SKIP_SIM=1 QSYS_SIMDIR=../scripts/ QUARTUS_INSTALL_DIR=$(QUARTUS_HOME) DEVICES_SIM_LIB_DIR=$(QUARTUS_INSTALL_DIR)/../devices/sim_lib2 QUARTUS_SIM_LIB_DIR=$(QUARTUS_INSTALL_DIR)/eda/sim_lib2 USER_DEFINED_COMPILE_OPTIONS="\"+define+__ALTERA_STD__METASTABLE_SIM +define+RTLSIM +define+UNHIDE_cr3v0 +define+TIMESCALE_EN +define+IP7581SERDES_UXS2T1R1PGD_PIPE_SPEC_FORCE +define+IP7581SERDES_UXS2T1R1PGD_PIPE_SIMULATION +define+IP7581SERDES_UXS2T1R1PGD_PIPE_FAST_SIM +define+INTC_FUNCTIONAL +define+SPEC_FORCE +define+RDY_LAT=0 +define+EHIP +define+FAST_CLK +define+CRETE3 +define+ACDS_19_1 +define+SRC_SPEC_SPEED_UP +define+SSM_SEQUENCE +define+IP7581SERDES_UX_SIMSPEED +define+IP7581SERDES_UXS2T1R1PGD_PIPE_SKIP_LOAD_SPEC +define+__SRC_TEST__ +define+QUARTUS_ENABLE_DPI_FORCE\"" TOP_LEVEL_NAME=qsys_top.qsys_top
gen_vip:
	mkdir -p ../vip/axi_vip/
