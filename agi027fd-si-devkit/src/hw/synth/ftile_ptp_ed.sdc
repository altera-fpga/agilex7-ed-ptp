...
set_clock_groups -asynchronous -group [get_clocks {inst_qsys_top|sys_manager|ftile_iopll_ptp_sampling|iopll_0_refclk}] -group [get_clocks {inst_port*_hssi_10G_25G_non_anlt_dr|hssi_ss_1|U_eth_f_inst_p8|eth_f_top_p8|*x_clkout2_p0|ch*}]
set_clock_groups -asynchronous -group [get_clocks {TOD_CLOCK}] -group [get_clocks {inst_port*_hssi_10G_25G_non_anlt_dr|hssi_ss_1|U_eth_f_inst_p8|eth_f_top_p8|*x_clkout2_p0|ch*}]
set_clock_groups -asynchronous -group [get_clocks {inst_qsys_top|sys_manager|tod_sync_25g_iopll_0|tod_sync_25g_iopll_0_n_cnt_clk (INVERTED)}] -group [get_clocks {inst_port1_hssi_10G_25G_non_anlt_dr|hssi_ss_1|U_eth_f_inst_p8|eth_f_top_p8|tx_clkout2_p0|ch*}]
set_clock_groups -asynchronous -group [get_clocks {inst_qsys_top|sys_manager|tod_sync_25g_iopll_0|tod_sync_25g_iopll_0_n_cnt_clk (INVERTED)}] -group [get_clocks {inst_port2_hssi_10G_25G_non_anlt_dr|hssi_ss_1|U_eth_f_inst_p8|eth_f_top_p8|tx_clkout2_p0|ch*}]
set_clock_groups -asynchronous -group [get_clocks {inst_qsys_top|sys_manager|tod_sync_25g_iopll_0|tod_sync_25g_iopll_0_n_cnt_clk (INVERTED)}] -group [get_clocks {inst_port1_hssi_10G_25G_non_anlt_dr|hssi_ss_1|U_eth_f_inst_p8|eth_f_top_p8|rx_clkout2_p0|ch*}]
set_clock_groups -asynchronous -group [get_clocks {inst_qsys_top|sys_manager|tod_sync_25g_iopll_0|tod_sync_25g_iopll_0_n_cnt_clk (INVERTED)}] -group [get_clocks {inst_port2_hssi_10G_25G_non_anlt_dr|hssi_ss_1|U_eth_f_inst_p8|eth_f_top_p8|rx_clkout2_p0|ch*}]
set_clock_groups -asynchronous -group [get_clocks {inst_qsys_top|sys_manager|ftile_iopll_todsync_sampling|ftile_iopll_todsync_sampling_n_cnt_clk (INVERTED)}] -group [get_clocks {inst_port1_hssi_10G_25G_non_anlt_dr|hssi_ss_1|U_eth_f_inst_p8|eth_f_top_p8|tx_clkout2_p0|ch*}]
set_clock_groups -asynchronous -group [get_clocks {inst_qsys_top|sys_manager|ftile_iopll_todsync_sampling|ftile_iopll_todsync_sampling_n_cnt_clk (INVERTED)}] -group [get_clocks {inst_port2_hssi_10G_25G_non_anlt_dr|hssi_ss_1|U_eth_f_inst_p8|eth_f_top_p8|tx_clkout2_p0|ch*}]
set_clock_groups -asynchronous -group [get_clocks {inst_qsys_top|sys_manager|ftile_iopll_todsync_sampling|ftile_iopll_todsync_sampling_n_cnt_clk (INVERTED)}] -group [get_clocks {inst_port1_hssi_10G_25G_non_anlt_dr|hssi_ss_1|U_eth_f_inst_p8|eth_f_top_p8|rx_clkout2_p0|ch*}]
set_clock_groups -asynchronous -group [get_clocks {inst_qsys_top|sys_manager|ftile_iopll_todsync_sampling|ftile_iopll_todsync_sampling_n_cnt_clk (INVERTED)}] -group [get_clocks {inst_port2_hssi_10G_25G_non_anlt_dr|hssi_ss_1|U_eth_f_inst_p8|eth_f_top_p8|rx_clkout2_p0|ch*}]
set_clock_groups -asynchronous -group [get_clocks {inst_port1_hssi_10G_25G_non_anlt_dr|hssi_ss_1|U_eth_f_inst_p8|eth_f_top_p8|tx_clkout2_p0|ch*}] -group [get_clocks {inst_port1_hssi_10G_25G_non_anlt_dr|hssi_ss_1|U_eth_f_inst_p8|eth_f_top_p8|rx_clkout2_p0|ch*}]
set_clock_groups -asynchronous -group [get_clocks {inst_port2_hssi_10G_25G_non_anlt_dr|hssi_ss_1|U_eth_f_inst_p8|eth_f_top_p8|tx_clkout2_p0|ch*}] -group [get_clocks {inst_port2_hssi_10G_25G_non_anlt_dr|hssi_ss_1|U_eth_f_inst_p8|eth_f_top_p8|rx_clkout2_p0|ch*}]
